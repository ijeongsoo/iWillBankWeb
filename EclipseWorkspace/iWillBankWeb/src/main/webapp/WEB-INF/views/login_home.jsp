...
<html>
	<head>
		...
		<title>iWillBank</title>
		<link rel="stylesheet" href="<%=application.getContextPath()%>/resources/css/style_3.css">
				...
				<!-- Main -->
					<div id="main">
						<div class="inner">
							...
							<!-- Header -->
								<header id="header">
									<a href="index.html" class="logo"><strong>I WILL BANK</strong> for 이정수님</a>
									<ul class="icons">
	...
	<div class="cd-user-modal">
		...
		<div class="cd-user-modal-container">
			<!-- this is the container wrapper -->
				...
				<P style="text-align:  center; margin:0 0 0 0; background-color: #FF625D; color: white; height: 65px; font-weight: bold; font-size: 40px; ">로그인</P>
			...
			<div id="cd-login">
				...
				<form id="loginForm" method="post"
					...
					<p class="fieldset">
						<input style= "font-size: 10px; padding:0;font-weight: bold; " class="full-width" type="submit" value="로그인">
					</p>
				</form>

				<p style="margin:0 0 0 0" class="cd-form-bottom-message">
	...
	<!-- cd-user-modal -->
		...
		<!-- Scripts -->
			...
			<script src="<%=application.getContextPath()%>/resources/assets/js/jquery.min.js"></script>
			<script src="<%=application.getContextPath()%>/resources/assets/js/browser.min.js"></script>
			<script src="<%=application.getContextPath()%>/resources/assets/js/breakpoints.min.js"></script>
			<script src="<%=application.getContextPath()%>/resources/assets/js/util.js"></script>
